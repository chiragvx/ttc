"""Whip Antenna Base -- Base fitting for a whip/rod antenna

Structural/mounting geometry only (`build-plan/reference/UAV_SUBSYSTEM_PROPOSALS.md` category
9) -- a cylinder with a concentric through-bore, the SAME shape family `standoff.py`
...
_FRAGMENT = """\
## Subsystem: Whip Antenna Base
Base fitting for a whip/rod antenna -- a cylindrical body with a concentric through-bore (FDM/FFF or turned).
...
WHIP_ANTENNA_BASE = register_subsystem(Subsystem(
    name="whip_antenna_base",
    description="Base fitting for a whip/rod antenna -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
