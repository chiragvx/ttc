"""Cg Adjustment Rail -- Rail letting a component slide to trim CG

Structural/mounting geometry only (`build-plan/reference/UAV_SUBSYSTEM_PROPOSALS.md` category
14) -- an extruded U-channel (base + two side walls, open top and both ends), the SAME
...
_FRAGMENT = """\
## Subsystem: Cg Adjustment Rail
Rail letting a component slide to trim CG -- an extruded U-channel, open at the top and both ends (FDM/FFF or extruded stock).
...
CG_ADJUSTMENT_RAIL = register_subsystem(Subsystem(
    name="cg_adjustment_rail",
    description="Rail letting a component slide to trim CG -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("length_mm", value=120.0, min=25.0, max=400.0, unit='mm'),
