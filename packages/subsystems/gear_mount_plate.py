"""Gear Mount Plate -- Plate the gear leg bolts to on the airframe
...
_FRAGMENT = """\
## Subsystem: Gear Mount Plate
Plate the gear leg bolts to on the airframe -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
GEAR_MOUNT_PLATE = register_subsystem(Subsystem(
    name="gear_mount_plate",
    description="Plate the gear leg bolts to on the airframe -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=60.0, min=15.0, max=200.0, unit='mm'),
        ParamSpec("depth_mm", value=50.0, min=12.0, max=180.0, unit='mm'),
