"""Servo Mount Tray -- Tray + screw pattern for a standard servo size
...
_FRAGMENT = """\
## Subsystem: Servo Mount Tray
Tray + screw pattern for a standard servo size -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
SERVO_MOUNT_TRAY = register_subsystem(Subsystem(
    name="servo_mount_tray",
    description="Tray + screw pattern for a standard servo size -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=45.0, min=15.0, max=150.0, unit='mm'),
