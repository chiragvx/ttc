"""Corner Bracket Gusseted -- L-bracket + triangular gusset for stiffness (gusset not modeled)
...
_FRAGMENT = """\
## Subsystem: Corner Bracket Gusseted
L-bracket + triangular gusset for stiffness (gusset not modeled) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
CORNER_BRACKET_GUSSETED = register_subsystem(Subsystem(
    name="corner_bracket_gusseted",
    description="L-bracket + triangular gusset for stiffness -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
