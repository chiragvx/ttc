"""Rivet Pattern Plate -- Plate pre-patterned with a rivet/fastener grid
...
_FRAGMENT = """\
## Subsystem: Rivet Pattern Plate
Plate pre-patterned with a rivet/fastener grid -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
RIVET_PATTERN_PLATE = register_subsystem(Subsystem(
    name="rivet_pattern_plate",
    description="Plate pre-patterned with a rivet/fastener grid -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=50.0, min=15.0, max=180.0, unit='mm'),
        ParamSpec("depth_mm", value=35.0, min=10.0, max=140.0, unit='mm'),
