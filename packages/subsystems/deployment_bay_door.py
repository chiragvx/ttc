"""Deployment Bay Door -- Door over a general deployment bay
...
_FRAGMENT = """\
## Subsystem: Deployment Bay Door
Door over a general deployment bay -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
DEPLOYMENT_BAY_DOOR = register_subsystem(Subsystem(
    name="deployment_bay_door",
    description="Door over a general deployment bay -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=60.0, min=18.0, max=220.0, unit='mm'),
        ParamSpec("depth_mm", value=40.0, min=12.0, max=160.0, unit='mm'),
