"""Hinge Line Bracket -- Bracket establishing a control-surface hinge line
...
_FRAGMENT = """\
## Subsystem: Hinge Line Bracket
Bracket establishing a control-surface hinge line -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
HINGE_LINE_BRACKET = register_subsystem(Subsystem(
    name="hinge_line_bracket",
    description="Bracket establishing a control-surface hinge line -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
