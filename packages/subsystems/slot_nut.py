"""Slot Nut -- Rectangular nut for T-slot extrusion
...
_FRAGMENT = """\
## Subsystem: Slot Nut
Rectangular nut for T-slot extrusion -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
SLOT_NUT = register_subsystem(Subsystem(
    name="slot_nut",
    description="Rectangular nut for T-slot extrusion -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=12.0, min=5.0, max=40.0, unit='mm'),
        ParamSpec("depth_mm", value=10.0, min=4.0, max=30.0, unit='mm'),
        ParamSpec("thickness_mm", value=6.0, min=2.0, max=20.0, unit='mm'),
        ParamSpec("hole_dia_mm", value=4.0, min=1.5, max=10.0, unit='mm'),
