"""Rudder Hinge Bracket -- Same, for the rudder hinge line
...
_FRAGMENT = """\
## Subsystem: Rudder Hinge Bracket
Same, for the rudder hinge line -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
RUDDER_HINGE_BRACKET = register_subsystem(Subsystem(
    name="rudder_hinge_bracket",
    description="Same, for the rudder hinge line -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
