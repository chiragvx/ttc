"""Stepped Spacer -- Two-diameter cylindrical spacer

Structural/mounting geometry only (`build-plan/reference/SUBSYSTEM_PROPOSALS.md` category
6) -- a two-diameter stepped/shouldered cylinder with an optional through-bore (bore_dia_mm
...
_FRAGMENT = """\
## Subsystem: Stepped Spacer
Two-diameter cylindrical spacer -- a two-diameter stepped/shouldered cylinder, optional through-bore.
...
STEPPED_SPACER = register_subsystem(Subsystem(
    ...
    params=[
        ParamSpec("dia1_mm", value=14.0, min=5.0, max=50.0, unit='mm'),
        ParamSpec("dia2_mm", value=8.0, min=3.0, max=40.0, unit='mm'),
