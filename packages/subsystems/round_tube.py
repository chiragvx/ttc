"""Round Tube -- Hollow round section
...
_FRAGMENT = """\
## Subsystem: Round Tube
Hollow round section -- a cylindrical body with a concentric through-bore (FDM/FFF or turned).
...
ROUND_TUBE = register_subsystem(Subsystem(
    name="round_tube",
    description="Hollow round section -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=20.0, min=6.0, max=100.0, unit='mm'),
        ParamSpec("inner_dia_mm", value=16.0, min=3.0, max=90.0, unit='mm'),
        ParamSpec("height_mm", value=300.0, min=20.0, max=1500.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
