"""Alignment Fork -- Two-prong locator (two-prong fork approximated as an L-bracket)
...
_FRAGMENT = """\
## Subsystem: Alignment Fork
Two-prong locator (two-prong fork approximated as an L-bracket) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
ALIGNMENT_FORK = register_subsystem(Subsystem(
    name="alignment_fork",
    description="Two-prong locator -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
