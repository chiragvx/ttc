"""Taper Pin -- Tapered alignment pin (continuous taper approximated as a 2-step profile)
...
_FRAGMENT = """\
## Subsystem: Taper Pin
Tapered alignment pin (continuous taper approximated as a 2-step profile) -- a two-diameter stepped/shouldered cylinder, optional through-bore.
...
TAPER_PIN = register_subsystem(Subsystem(
    ...
    params=[
        ParamSpec("dia1_mm", value=6.0, min=2.0, max=20.0, unit='mm'),
        ParamSpec("dia2_mm", value=4.0, min=1.0, max=16.0, unit='mm'),
        ParamSpec("len1_mm", value=10.0, min=2.0, max=40.0, unit='mm'),
        ParamSpec("len2_mm", value=10.0, min=2.0, max=40.0, unit='mm'),
