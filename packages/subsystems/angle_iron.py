"""Angle Iron -- Extruded L cross-section (structural stock length)
...
_FRAGMENT = """\
## Subsystem: Angle Iron
Extruded L cross-section (structural stock length) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
ANGLE_IRON = register_subsystem(Subsystem(
    name="angle_iron",
    description="Extruded L cross-section (structural stock length) -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=25.0, min=10.0, max=80.0, unit='mm'),
        ParamSpec("leg_b_mm", value=25.0, min=10.0, max=80.0, unit='mm'),
        ParamSpec("width_mm", value=300.0, min=30.0, max=1200.0, unit='mm'),
