"""Rf Shield Mount -- Mount/clip for an RF shield can
...
_FRAGMENT = """\
## Subsystem: Rf Shield Mount
Mount/clip for an RF shield can -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
RF_SHIELD_MOUNT = register_subsystem(Subsystem(
    name="rf_shield_mount",
    description="Mount/clip for an RF shield can -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
