"""Tapered Grip -- Ergonomic tapered grip (continuous taper approximated as a 2-step profile)

Structural/mounting geometry only (`build-plan/reference/SUBSYSTEM_PROPOSALS.md` category
11) -- a two-diameter stepped/shouldered cylinder with an optional through-bore (bore_dia_mm
...
_FRAGMENT = """\
## Subsystem: Tapered Grip
Ergonomic tapered grip (continuous taper approximated as a 2-step profile) -- a two-diameter stepped/shouldered cylinder, optional through-bore.
...
TAPERED_GRIP = register_subsystem(Subsystem(
    ...
    params=[
        ParamSpec("dia1_mm", value=25.0, min=8.0, max=70.0, unit='mm'),
        ParamSpec("dia2_mm", value=15.0, min=5.0, max=55.0, unit='mm'),
        ParamSpec("len1_mm", value=40.0, min=10.0, max=130.0, unit='mm'),
        ParamSpec("len2_mm", value=40.0, min=10.0, max=130.0, unit='mm'),
