"""Fuel Tank Tray -- Tray/cradle holding a fuel tank or battery pack
...
_FRAGMENT = """\
## Subsystem: Fuel Tank Tray
Tray/cradle holding a fuel tank or battery pack -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
FUEL_TANK_TRAY = register_subsystem(Subsystem(
    name="fuel_tank_tray",
    description="Tray/cradle holding a fuel tank or battery pack -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=70.0, min=20.0, max=250.0, unit='mm'),
        ParamSpec("depth_mm", value=50.0, min=15.0, max=200.0, unit='mm'),
