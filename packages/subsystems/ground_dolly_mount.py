"""Ground Dolly Mount -- Mount point for a ground-handling dolly
...
_FRAGMENT = """\
## Subsystem: Ground Dolly Mount
Mount point for a ground-handling dolly -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
GROUND_DOLLY_MOUNT = register_subsystem(Subsystem(
    name="ground_dolly_mount",
    description="Mount point for a ground-handling dolly -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
