"""Fuselage Ring Frame -- Full ring frame with mounting flange
...
_FRAGMENT = """\
## Subsystem: Fuselage Ring Frame
Full ring frame with mounting flange -- a flat ring frame perpendicular to the fuselage axis (FDM/FFF or CNC).
...
FUSELAGE_RING_FRAME = register_subsystem(Subsystem(
    name="fuselage_ring_frame",
    description="Full ring frame with mounting flange -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=120.0, min=60.0, max=400.0, unit='mm'),
