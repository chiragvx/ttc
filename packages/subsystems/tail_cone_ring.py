"""Tail Cone Ring -- Aft-most ring frame
...
_FRAGMENT = """\
## Subsystem: Tail Cone Ring
Aft-most ring frame -- a flat ring frame perpendicular to the fuselage axis (FDM/FFF or CNC).
...
TAIL_CONE_RING = register_subsystem(Subsystem(
    name="tail_cone_ring",
    description="Aft-most ring frame -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=70.0, min=30.0, max=250.0, unit='mm'),
