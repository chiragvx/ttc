"""Deck Plate -- Internal mounting-level plate, satellite-specific sizing presets
...
_FRAGMENT = """\
## Subsystem: Deck Plate
Internal mounting-level plate, satellite-specific sizing presets -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
DECK_PLATE = register_subsystem(Subsystem(
    name="deck_plate",
    description="Internal mounting-level plate, satellite-specific sizing presets -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=90.0, min=20.0, max=300.0, unit='mm'),
        ParamSpec("depth_mm", value=90.0, min=20.0, max=300.0, unit='mm'),
