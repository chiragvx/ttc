"""Flanged Bushing -- Bushing with an outboard flange
...
_FRAGMENT = """\
## Subsystem: Flanged Bushing
Bushing with an outboard flange -- a shaft/boss on a wider mounting flange, concentric bore, flange bolt-hole pattern.
...
FLANGED_BUSHING = register_subsystem(Subsystem(
    ...
    params=[
        ...
        ParamSpec("flange_dia_mm", value=18.0, min=6.0, max=60.0, unit='mm'),
