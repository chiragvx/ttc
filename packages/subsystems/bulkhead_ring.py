"""Bulkhead Ring -- Ring-shaped internal frame with lightening holes
...
_FRAGMENT = """\
## Subsystem: Bulkhead Ring
Ring-shaped internal frame with lightening holes -- a flat ring frame perpendicular to the fuselage axis (FDM/FFF or CNC).
...
BULKHEAD_RING = register_subsystem(Subsystem(
    name="bulkhead_ring",
    description="Ring-shaped internal frame with lightening holes -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=105.0, min=35.0, max=350.0, unit='mm'),
