"""Spinner Backplate -- Backplate a spinner cone bolts to
...
_FRAGMENT = """\
## Subsystem: Spinner Backplate
Backplate a spinner cone bolts to -- a cylindrical body with a concentric through-bore (FDM/FFF or turned).
...
SPINNER_BACKPLATE = register_subsystem(Subsystem(
    name="spinner_backplate",
    description="Backplate a spinner cone bolts to -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=35.0, min=12.0, max=120.0, unit='mm'),
        ParamSpec("inner_dia_mm", value=8.0, min=2.0, max=60.0, unit='mm'),
        ParamSpec("height_mm", value=4.0, min=1.0, max=20.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
