"""Cowl Mount Bracket -- Bracket securing a cowl to the firewall
...
_FRAGMENT = """\
## Subsystem: Cowl Mount Bracket
Bracket securing a cowl to the firewall -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
COWL_MOUNT_BRACKET = register_subsystem(Subsystem(
    name="cowl_mount_bracket",
    description="Bracket securing a cowl to the firewall -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=20.0, min=8.0, max=70.0, unit='mm'),
        ParamSpec("leg_b_mm", value=20.0, min=8.0, max=70.0, unit='mm'),
        ParamSpec("width_mm", value=14.0, min=5.0, max=50.0, unit='mm'),
