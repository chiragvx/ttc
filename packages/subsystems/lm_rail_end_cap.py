"""Lm Rail End Cap -- End cap for a linear rail
...
_FRAGMENT = """\
## Subsystem: Lm Rail End Cap
End cap for a linear rail -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
LM_RAIL_END_CAP = register_subsystem(Subsystem(
    name="lm_rail_end_cap",
    description="End cap for a linear rail -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=20.0, min=6.0, max=60.0, unit='mm'),
        ParamSpec("depth_mm", value=15.0, min=5.0, max=45.0, unit='mm'),
