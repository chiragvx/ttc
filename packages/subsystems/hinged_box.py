"""Hinged Box -- Box + lid + integrated hinge knuckles (hinge knuckles not modeled)
...
_FRAGMENT = """\
## Subsystem: Hinged Box
Box + lid + integrated hinge knuckles (hinge knuckles not modeled) -- an open-top rectangular shell (FDM/FFF), a floor of thickness wall_mm, open at the
...
HINGED_BOX = register_subsystem(Subsystem(
    name="hinged_box",
    description="Box + lid + integrated hinge knuckles -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
