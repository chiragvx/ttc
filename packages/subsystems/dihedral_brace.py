"""Dihedral Brace -- Fitting that sets/locks the dihedral angle at the root
...
_FRAGMENT = """\
## Subsystem: Dihedral Brace
Fitting that sets/locks the dihedral angle at the root -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
DIHEDRAL_BRACE = register_subsystem(Subsystem(
    name="dihedral_brace",
    description="Fitting that sets/locks the dihedral angle at the root -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=35.0, min=15.0, max=100.0, unit='mm'),
        ParamSpec("leg_b_mm", value=35.0, min=15.0, max=100.0, unit='mm'),
        ParamSpec("width_mm", value=20.0, min=8.0, max=80.0, unit='mm'),
