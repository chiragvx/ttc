"""Drill Jig -- Plate + drill-bushing bores (drill bushings not separately modeled, approximated as bores)
...
_FRAGMENT = """\
## Subsystem: Drill Jig
Plate + drill-bushing bores (drill bushings not separately modeled, approximated as bores) -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
DRILL_JIG = register_subsystem(Subsystem(
    name="drill_jig",
    description="Plate + drill-bushing bores -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    ...
    params=[
        ...
        ParamSpec("n_holes", value=4, min=0, max=10, unit='count'),
