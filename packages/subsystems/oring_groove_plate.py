"""Oring Groove Plate -- Plate with a rectangular O-ring groove and bolt holes (O-ring groove not modeled)
...
_FRAGMENT = """\
## Subsystem: Oring Groove Plate
Plate with a rectangular O-ring groove and bolt holes (O-ring groove not modeled) -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
ORING_GROOVE_PLATE = register_subsystem(Subsystem(
    name="oring_groove_plate",
    description="Plate with a rectangular O-ring groove and bolt holes -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=60.0, min=15.0, max=220.0, unit='mm'),
