"""Wiring Channel -- Channel/raceway that routes a wiring bundle
...
_FRAGMENT = """\
## Subsystem: Wiring Channel
Channel/raceway that routes a wiring bundle -- an extruded U-channel, open at the top and both ends (FDM/FFF or extruded stock).
...
WIRING_CHANNEL = register_subsystem(Subsystem(
    name="wiring_channel",
    description="Channel/raceway that routes a wiring bundle -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
