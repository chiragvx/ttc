"""Battery Bay Divider -- Divider wall between two battery bays
...
_FRAGMENT = """\
## Subsystem: Battery Bay Divider
Divider wall between two battery bays -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
BATTERY_BAY_DIVIDER = register_subsystem(Subsystem(
    name="battery_bay_divider",
    description="Divider wall between two battery bays -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
