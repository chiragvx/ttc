"""Keel Beam -- Central spine beam running the fuselage length
...
_FRAGMENT = """\
## Subsystem: Keel Beam
Central spine beam running the fuselage length -- a solid rectangular bar (FDM/FFF or CNC).
...
KEEL_BEAM = register_subsystem(Subsystem(
    name="keel_beam",
    description="Central spine beam running the fuselage length -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    ...
    params=[
        ...
        ParamSpec("height_mm", value=15.0, min=3.0, max=80.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
