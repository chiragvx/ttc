"""Elevator Hinge Bracket -- Structural hinge-line bracket (not the control surface itself)
...
_FRAGMENT = """\
## Subsystem: Elevator Hinge Bracket
Structural hinge-line bracket (not the control surface itself) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
ELEVATOR_HINGE_BRACKET = register_subsystem(Subsystem(
    name="elevator_hinge_bracket",
    description="Structural hinge-line bracket (not the control surface itself) -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
