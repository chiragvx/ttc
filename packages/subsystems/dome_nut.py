"""Dome Nut -- Sealing dome (blind acorn) (dome not modeled)
...
_FRAGMENT = """\
## Subsystem: Dome Nut
Sealing dome (blind acorn) (dome not modeled) -- a solid cylindrical body (FDM/FFF or turned). Fine surface detail (knurling, a domed
...
DOME_NUT = register_subsystem(Subsystem(
    name="dome_nut",
    description="Sealing dome (blind acorn) -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("dia_mm", value=10.0, min=4.0, max=30.0, unit='mm'),
        ParamSpec("height_mm", value=10.0, min=3.0, max=30.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
