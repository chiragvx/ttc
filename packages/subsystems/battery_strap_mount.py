"""Battery Strap Mount -- Strap anchor points on either side of the battery bay
...
_FRAGMENT = """\
## Subsystem: Battery Strap Mount
Strap anchor points on either side of the battery bay -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
BATTERY_STRAP_MOUNT = register_subsystem(Subsystem(
    name="battery_strap_mount",
    description="Strap anchor points on either side of the battery bay -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
