"""Payload Bay Door -- Hinged or removable door over a payload bay

Structural/mounting geometry only (`build-plan/reference/UAV_SUBSYSTEM_PROPOSALS.md` category
6) -- a flat mounting plate with a row of bolt holes, the SAME shape family
...
_FRAGMENT = """\
## Subsystem: Payload Bay Door
Hinged or removable door over a payload bay -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
PAYLOAD_BAY_DOOR = register_subsystem(Subsystem(
    name="payload_bay_door",
    description="Hinged or removable door over a payload bay -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=90.0, min=25.0, max=300.0, unit='mm'),
