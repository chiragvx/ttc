"""Keystone Plate -- Plate with the keystone-jack rectangular cut-outs (rectangular keystone cutouts approximated as round holes)
...
_FRAGMENT = """\
## Subsystem: Keystone Plate
Plate with the keystone-jack rectangular cut-outs (rectangular keystone cutouts approximated as round holes) -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
KEYSTONE_PLATE = register_subsystem(Subsystem(
    name="keystone_plate",
    description="Plate with the keystone-jack rectangular cut-outs -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    ...
    params=[
        ...
        ParamSpec("hole_dia_mm", value=14.5, min=5.0, max=25.0, unit='mm'),
        ParamSpec("n_holes", value=2, min=0, max=6, unit='count'),
