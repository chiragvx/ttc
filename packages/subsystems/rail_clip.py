"""Rail Clip -- Clip securing wiring/harness to a cubesat rail
...
_FRAGMENT = """\
## Subsystem: Rail Clip
Clip securing wiring/harness to a cubesat rail -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
RAIL_CLIP = register_subsystem(Subsystem(
    name="rail_clip",
    description="Clip securing wiring/harness to a cubesat rail -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    ...
    params=[
        ...
        ParamSpec("thickness_mm", value=1.5, min=0.6, max=6.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
