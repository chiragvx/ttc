"""Wing Tip Fitting -- Structural closure/end cap at the wingtip
...
_FRAGMENT = """\
## Subsystem: Wing Tip Fitting
Structural closure/end cap at the wingtip -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
WING_TIP_FITTING = register_subsystem(Subsystem(
    name="wing_tip_fitting",
    description="Structural closure/end cap at the wingtip -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=40.0, min=10.0, max=150.0, unit='mm'),
