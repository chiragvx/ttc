"""Prop Spacer -- Simple spacer disc behind a prop
...
_FRAGMENT = """\
## Subsystem: Prop Spacer
Simple spacer disc behind a prop -- a cylindrical body with a concentric through-bore (FDM/FFF or turned).
...
PROP_SPACER = register_subsystem(Subsystem(
    name="prop_spacer",
    description="Simple spacer disc behind a prop -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=15.0, min=6.0, max=50.0, unit='mm'),
        ParamSpec("inner_dia_mm", value=5.0, min=1.0, max=35.0, unit='mm'),
        ParamSpec("height_mm", value=5.0, min=1.0, max=25.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
