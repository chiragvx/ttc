"""Flange Bearing Housing -- 4-bolt flange bearing shell
...
_FRAGMENT = """\
## Subsystem: Flange Bearing Housing
4-bolt flange bearing shell -- a shaft/boss on a wider mounting flange, concentric bore, flange bolt-hole pattern.
...
FLANGE_BEARING_HOUSING = register_subsystem(Subsystem(
    name="flange_bearing_housing",
    description="4-bolt flange bearing shell -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("shaft_dia_mm", value=18.0, min=6.0, max=55.0, unit='mm'),
        ParamSpec("shaft_len_mm", value=10.0, min=3.0, max=30.0, unit='mm'),
        ParamSpec("flange_dia_mm", value=45.0, min=14.0, max=110.0, unit='mm'),
        ParamSpec("flange_thickness_mm", value=8.0, min=2.0, max=25.0, unit='mm'),
        ParamSpec("bore_dia_mm", value=12.0, min=4.0, max=45.0, unit='mm'),
        ParamSpec("n_bolt_holes", value=4, min=4, max=4, unit='count'),
