"""Fuse Holder Bracket -- Bracket holding an inline fuse holder

Structural/mounting geometry only (`build-plan/reference/UAV_SUBSYSTEM_PROPOSALS.md` category
7) -- two perpendicular flanges sharing a corner, the SAME shape family `lbracket.py`
...
_FRAGMENT = """\
## Subsystem: Fuse Holder Bracket
Bracket holding an inline fuse holder -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
FUSE_HOLDER_BRACKET = register_subsystem(Subsystem(
    name="fuse_holder_bracket",
    description="Bracket holding an inline fuse holder -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
