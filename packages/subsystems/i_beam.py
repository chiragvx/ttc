"""I Beam -- I / H cross-section (approximated as a U-channel, not a true I/H section)
...
_FRAGMENT = """\
## Subsystem: I Beam
I / H cross-section (approximated as a U-channel, not a true I/H section) -- an extruded U-channel, open at the top and both ends (FDM/FFF or extruded stock).
...
I_BEAM = register_subsystem(Subsystem(
    name="i_beam",
    description="I / H cross-section -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    ...
    params=[
        ...
        ParamSpec("height_mm", value=40.0, min=12.0, max=150.0, unit='mm'),
