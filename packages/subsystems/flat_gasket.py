"""Flat Gasket -- Rectangular gasket blank with bolt holes
...
_FRAGMENT = """\
## Subsystem: Flat Gasket
Rectangular gasket blank with bolt holes -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
FLAT_GASKET = register_subsystem(Subsystem(
    name="flat_gasket",
    description="Rectangular gasket blank with bolt holes -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=60.0, min=15.0, max=220.0, unit='mm'),
        ParamSpec("depth_mm", value=40.0, min=10.0, max=180.0, unit='mm'),
        ParamSpec("thickness_mm", value=1.5, min=0.5, max=6.0, unit='mm'),
