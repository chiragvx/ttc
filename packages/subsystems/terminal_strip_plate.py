"""Terminal Strip Plate -- Plate + strip of pass-through holes
...
_FRAGMENT = """\
## Subsystem: Terminal Strip Plate
Plate + strip of pass-through holes -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
TERMINAL_STRIP_PLATE = register_subsystem(Subsystem(
    name="terminal_strip_plate",
    description="Plate + strip of pass-through holes -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    ...
    params=[
        ...
        ParamSpec("n_holes", value=8, min=2, max=16, unit='count'),
