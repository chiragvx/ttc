"""Wing Spar -- Straight structural beam (not airfoil-shaped)
...
_FRAGMENT = """\
## Subsystem: Wing Spar
Straight structural beam (not airfoil-shaped) -- a solid rectangular bar (FDM/FFF or CNC).
...
WING_SPAR = register_subsystem(Subsystem(
    name="wing_spar",
    description="Straight structural beam (not airfoil-shaped) -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("length_mm", value=500.0, min=100.0, max=2000.0, unit='mm'),
        ParamSpec("width_mm", value=15.0, min=5.0, max=80.0, unit='mm'),
