"""Camera Mount Static -- Fixed (non-gimbaled) camera mount plate + bracket
...
_FRAGMENT = """\
## Subsystem: Camera Mount Static
Fixed (non-gimbaled) camera mount plate + bracket -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
CAMERA_MOUNT_STATIC = register_subsystem(Subsystem(
    name="camera_mount_static",
    description="Fixed (non-gimbaled) camera mount plate + bracket -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
