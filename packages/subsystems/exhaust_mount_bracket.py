"""Exhaust Mount Bracket -- Bracket standing off an exhaust/muffler
...
_FRAGMENT = """\
## Subsystem: Exhaust Mount Bracket
Bracket standing off an exhaust/muffler -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
EXHAUST_MOUNT_BRACKET = register_subsystem(Subsystem(
    name="exhaust_mount_bracket",
    description="Bracket standing off an exhaust/muffler -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=25.0, min=10.0, max=80.0, unit='mm'),
        ParamSpec("leg_b_mm", value=20.0, min=8.0, max=70.0, unit='mm'),
        ParamSpec("width_mm", value=16.0, min=5.0, max=60.0, unit='mm'),
