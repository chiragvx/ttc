"""Launch Rail Shoe -- Shoe that rides a launch rail
...
_FRAGMENT = """\
## Subsystem: Launch Rail Shoe
Shoe that rides a launch rail -- an extruded U-channel, open at the top and both ends (FDM/FFF or extruded stock).
...
LAUNCH_RAIL_SHOE = register_subsystem(Subsystem(
    name="launch_rail_shoe",
    description="Shoe that rides a launch rail -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("length_mm", value=40.0, min=12.0, max=150.0, unit='mm'),
