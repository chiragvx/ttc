"""Cable Clip -- Semi-circular clip with mounting flange (semi-circular clip approximated as an L-bracket)
...
_FRAGMENT = """\
## Subsystem: Cable Clip
Semi-circular clip with mounting flange (semi-circular clip approximated as an L-bracket) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
CABLE_CLIP = register_subsystem(Subsystem(
    name="cable_clip",
    description="Semi-circular clip with mounting flange -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=12.0, min=5.0, max=40.0, unit='mm'),
        ParamSpec("leg_b_mm", value=12.0, min=5.0, max=40.0, unit='mm'),
        ParamSpec("width_mm", value=10.0, min=4.0, max=35.0, unit='mm'),
