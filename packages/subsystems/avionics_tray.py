"""Avionics Tray -- Plate + standoff bosses sized to a PCB hole pattern
...
_FRAGMENT = """\
## Subsystem: Avionics Tray
Plate + standoff bosses sized to a PCB hole pattern -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
AVIONICS_TRAY = register_subsystem(Subsystem(
    name="avionics_tray",
    description="Plate + standoff bosses sized to a PCB hole pattern -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
