"""Skin Attach Frame -- Frame with a flange a skin panel bolts/bonds to
...
_FRAGMENT = """\
## Subsystem: Skin Attach Frame
Frame with a flange a skin panel bolts/bonds to -- a flat ring frame perpendicular to the fuselage axis (FDM/FFF or CNC).
...
SKIN_ATTACH_FRAME = register_subsystem(Subsystem(
    name="skin_attach_frame",
    description="Frame with a flange a skin panel bolts/bonds to -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=110.0, min=50.0, max=350.0, unit='mm'),
        ParamSpec("flange_width_mm", value=10.0, min=3.0, max=30.0, unit='mm'),
        ParamSpec("thickness_mm", value=2.5, min=1.0, max=8.0, unit='mm'),
        ParamSpec("num_bolt_holes", value=8, min=3, max=20, unit='count'),
