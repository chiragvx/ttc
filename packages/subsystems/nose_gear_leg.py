...
_FRAGMENT = """\
## Subsystem: Nose Gear Leg
Nose gear leg -- a solid rectangular bar (FDM/FFF or CNC).
...
NOSE_GEAR_LEG = register_subsystem(Subsystem(
    name="nose_gear_leg",
    description="Nose gear leg -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("length_mm", value=140.0, min=30.0, max=500.0, unit='mm'),
        ParamSpec("width_mm", value=10.0, min=3.0, max=50.0, unit='mm'),
        ParamSpec("height_mm", value=7.0, min=2.0, max=35.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
