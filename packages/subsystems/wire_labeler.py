"""Wire Labeler -- Cylindrical/rectangular label sleeve

Structural/mounting geometry only (`build-plan/reference/SUBSYSTEM_PROPOSALS.md` category
12) -- a plain solid cylinder. Fine surface/profile detail this part's real-world name
...
Cylindrical/rectangular label sleeve -- a solid cylindrical body (FDM/FFF or turned). Fine surface detail (knurling, a domed
...
WIRE_LABELER = register_subsystem(Subsystem(
    name="wire_labeler",
    description="Cylindrical/rectangular label sleeve -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("dia_mm", value=8.0, min=3.0, max=25.0, unit='mm'),
        ParamSpec("height_mm", value=15.0, min=4.0, max=40.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
