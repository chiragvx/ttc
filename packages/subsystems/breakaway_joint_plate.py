"""Breakaway Joint Plate -- Plate designed as a deliberate break point
...
_FRAGMENT = """\
## Subsystem: Breakaway Joint Plate
Plate designed as a deliberate break point -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
BREAKAWAY_JOINT_PLATE = register_subsystem(Subsystem(
    name="breakaway_joint_plate",
    description="Plate designed as a deliberate break point -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=25.0, min=8.0, max=90.0, unit='mm'),
        ParamSpec("depth_mm", value=15.0, min=5.0, max=60.0, unit='mm'),
