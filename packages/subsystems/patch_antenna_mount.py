"""Patch Antenna Mount -- Mount sized for a patch-antenna PCB
...
_FRAGMENT = """\
## Subsystem: Patch Antenna Mount
Mount sized for a patch-antenna PCB -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
PATCH_ANTENNA_MOUNT = register_subsystem(Subsystem(
    name="patch_antenna_mount",
    description="Mount sized for a patch-antenna PCB -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=35.0, min=12.0, max=120.0, unit='mm'),
        ParamSpec("depth_mm", value=35.0, min=12.0, max=120.0, unit='mm'),
