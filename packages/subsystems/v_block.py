"""V Block -- Rectangular block with a V-groove (V-groove not modeled)
...
_FRAGMENT = """\
## Subsystem: V Block
Rectangular block with a V-groove (V-groove not modeled) -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
V_BLOCK = register_subsystem(Subsystem(
    name="v_block",
    description="Rectangular block with a V-groove -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=40.0, min=12.0, max=120.0, unit='mm'),
