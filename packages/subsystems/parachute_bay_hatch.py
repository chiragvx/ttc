"""Parachute Bay Hatch -- Hatch covering a recovery-parachute bay
...
_FRAGMENT = """\
## Subsystem: Parachute Bay Hatch
Hatch covering a recovery-parachute bay -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
PARACHUTE_BAY_HATCH = register_subsystem(Subsystem(
    name="parachute_bay_hatch",
    description="Hatch covering a recovery-parachute bay -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
