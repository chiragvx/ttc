"""Sliding Lid Box -- Box + rail-and-slot sliding lid (rail-and-slot not modeled)
...
_FRAGMENT = """\
## Subsystem: Sliding Lid Box
Box + rail-and-slot sliding lid (rail-and-slot not modeled) -- an open-top rectangular shell (FDM/FFF), a floor of thickness wall_mm, open at the
...
SLIDING_LID_BOX = register_subsystem(Subsystem(
    name="sliding_lid_box",
    description="Box + rail-and-slot sliding lid -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
