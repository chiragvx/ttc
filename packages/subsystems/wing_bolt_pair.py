"""Wing Bolt Pair -- Matched bolt + reinforced bore pair for a bolt-on wing
...
_FRAGMENT = """\
## Subsystem: Wing Bolt Pair
Matched bolt + reinforced bore pair for a bolt-on wing -- a cylindrical body with a concentric through-bore (FDM/FFF or turned).
...
WING_BOLT_PAIR = register_subsystem(Subsystem(
    name="wing_bolt_pair",
    description="Matched bolt + reinforced bore pair for a bolt-on wing -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=10.0, min=4.0, max=30.0, unit='mm'),
        ParamSpec("inner_dia_mm", value=4.0, min=1.0, max=20.0, unit='mm'),
