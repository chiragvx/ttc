"""Pulley Blank Flat -- Flat-face pulley
...
Flat-face pulley -- a solid cylindrical body (FDM/FFF or turned). Fine surface detail (knurling, a domed
...
PULLEY_BLANK_FLAT = register_subsystem(Subsystem(
    name="pulley_blank_flat",
    description="Flat-face pulley -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
