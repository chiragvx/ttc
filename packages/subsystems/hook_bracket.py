"""Hook Bracket -- Small plate + upturned hook (hook curve not modeled)
...
_FRAGMENT = """\
## Subsystem: Hook Bracket
Small plate + upturned hook (hook curve not modeled) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
HOOK_BRACKET = register_subsystem(Subsystem(
    name="hook_bracket",
    description="Small plate + upturned hook -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
