"""Turnbuckle Blank -- Turnbuckle body blank (rigging tension, thread not modelled)
...
_FRAGMENT = """\
## Subsystem: Turnbuckle Blank
Turnbuckle body blank (rigging tension, thread not modelled) -- a cylindrical body with a concentric through-bore (FDM/FFF or turned).
...
TURNBUCKLE_BLANK = register_subsystem(Subsystem(
    name="turnbuckle_blank",
    description="Turnbuckle body blank (rigging tension, thread not modelled) -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("outer_dia_mm", value=8.0, min=3.0, max=30.0, unit='mm'),
        ParamSpec("inner_dia_mm", value=3.0, min=1.0, max=20.0, unit='mm'),
