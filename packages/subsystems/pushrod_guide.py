"""Pushrod Guide -- Tube/guide keeping a pushrod straight over a span
...
_FRAGMENT = """\
## Subsystem: Pushrod Guide
Tube/guide keeping a pushrod straight over a span -- a cylindrical body with a concentric through-bore (FDM/FFF or turned).
...
PUSHROD_GUIDE = register_subsystem(Subsystem(
    name="pushrod_guide",
    description="Tube/guide keeping a pushrod straight over a span -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    ...
    params=[
        ...
        ParamSpec("height_mm", value=40.0, min=10.0, max=150.0, unit='mm'),
    ],
    build=_build,
    volume=_volume,
    invariants=_check,
