"""Cbracket -- C-shape (two flanges + short web)
...
_FRAGMENT = """\
## Subsystem: Cbracket
C-shape (two flanges + short web) -- an extruded U-channel, open at the top and both ends (FDM/FFF or extruded stock).
...
CBRACKET = register_subsystem(Subsystem(
    name="cbracket",
    description="C-shape (two flanges + short web) -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("length_mm", value=60.0, min=15.0, max=200.0, unit='mm'),
