"""Label Plate -- Plate with recessed label pocket (recessed pocket not modeled)
...
_FRAGMENT = """\
## Subsystem: Label Plate
Plate with recessed label pocket (recessed pocket not modeled) -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
LABEL_PLATE = register_subsystem(Subsystem(
    name="label_plate",
    description="Plate with recessed label pocket -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=40.0, min=12.0, max=150.0, unit='mm'),
        ParamSpec("depth_mm", value=18.0, min=5.0, max=70.0, unit='mm'),
