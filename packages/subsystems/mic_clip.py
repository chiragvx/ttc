"""Mic Clip -- Flexible-arm clip for a cylindrical body (flexure arm not modeled)
...
_FRAGMENT = """\
## Subsystem: Mic Clip
Flexible-arm clip for a cylindrical body (flexure arm not modeled) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
MIC_CLIP = register_subsystem(Subsystem(
    name="mic_clip",
    description="Flexible-arm clip for a cylindrical body -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=18.0, min=6.0, max=60.0, unit='mm'),
        ParamSpec("leg_b_mm", value=18.0, min=6.0, max=60.0, unit='mm'),
        ParamSpec("width_mm", value=12.0, min=4.0, max=45.0, unit='mm'),
