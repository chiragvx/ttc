"""Coax Clamp -- Small clamp securing a coax run at intervals
...
_FRAGMENT = """\
## Subsystem: Coax Clamp
Small clamp securing a coax run at intervals -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
COAX_CLAMP = register_subsystem(Subsystem(
    name="coax_clamp",
    description="Small clamp securing a coax run at intervals -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=10.0, min=4.0, max=35.0, unit='mm'),
        ParamSpec("leg_b_mm", value=10.0, min=4.0, max=35.0, unit='mm'),
        ParamSpec("width_mm", value=6.0, min=2.0, max=25.0, unit='mm'),
