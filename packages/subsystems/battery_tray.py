"""Battery Tray -- Tray/cradle sized to a battery pack
...
_FRAGMENT = """\
## Subsystem: Battery Tray
Tray/cradle sized to a battery pack -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
BATTERY_TRAY = register_subsystem(Subsystem(
    name="battery_tray",
    description="Tray/cradle sized to a battery pack -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=80.0, min=20.0, max=250.0, unit='mm'),
        ParamSpec("depth_mm", value=50.0, min=15.0, max=180.0, unit='mm'),
