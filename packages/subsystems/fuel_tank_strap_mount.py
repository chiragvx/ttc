"""Fuel Tank Strap Mount -- Strap anchor points either side of a tank bay
...
_FRAGMENT = """\
## Subsystem: Fuel Tank Strap Mount
Strap anchor points either side of a tank bay -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
FUEL_TANK_STRAP_MOUNT = register_subsystem(Subsystem(
    name="fuel_tank_strap_mount",
    description="Strap anchor points either side of a tank bay -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
