"""Catapult Hook -- Hook for a bungee/catapult launch

Structural/mounting geometry only (`build-plan/reference/UAV_SUBSYSTEM_PROPOSALS.md` category
11) -- two perpendicular flanges sharing a corner, the SAME shape family `lbracket.py`
...
_FRAGMENT = """\
## Subsystem: Catapult Hook
Hook for a bungee/catapult launch -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
CATAPULT_HOOK = register_subsystem(Subsystem(
    name="catapult_hook",
    description="Hook for a bungee/catapult launch -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=20.0, min=8.0, max=70.0, unit='mm'),
        ParamSpec("leg_b_mm", value=15.0, min=6.0, max=60.0, unit='mm'),
