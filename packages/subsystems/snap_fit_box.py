"""Snap Fit Box -- Box + lid with snap-fit tabs (snap-fit tabs not modeled)
...
_FRAGMENT = """\
## Subsystem: Snap Fit Box
Box + lid with snap-fit tabs (snap-fit tabs not modeled) -- an open-top rectangular shell (FDM/FFF), a floor of thickness wall_mm, open at the
...
SNAP_FIT_BOX = register_subsystem(Subsystem(
    name="snap_fit_box",
    description="Box + lid with snap-fit tabs -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=70.0, min=18.0, max=220.0, unit='mm'),
