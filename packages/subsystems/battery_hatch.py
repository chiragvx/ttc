"""Battery Hatch -- Removable hatch over the battery bay
...
_FRAGMENT = """\
## Subsystem: Battery Hatch
Removable hatch over the battery bay -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
BATTERY_HATCH = register_subsystem(Subsystem(
    name="battery_hatch",
    description="Removable hatch over the battery bay -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=85.0, min=22.0, max=260.0, unit='mm'),
        ParamSpec("depth_mm", value=55.0, min=16.0, max=190.0, unit='mm'),
