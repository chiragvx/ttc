"""Skid Pad -- Flat skid (skid-gear aircraft, no wheels)
...
_FRAGMENT = """\
## Subsystem: Skid Pad
Flat skid (skid-gear aircraft, no wheels) -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
SKID_PAD = register_subsystem(Subsystem(
    name="skid_pad",
    description="Flat skid (skid-gear aircraft, no wheels) -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=70.0, min=15.0, max=250.0, unit='mm'),
        ...
        ParamSpec("n_holes", value=0, min=0, max=6, unit='count'),
