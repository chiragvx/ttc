"""Keyhole Slot Plate -- Plate with keyhole-shape hanging slots (keyhole shape approximated as round holes)
...
_FRAGMENT = """\
## Subsystem: Keyhole Slot Plate
Plate with keyhole-shape hanging slots (keyhole shape approximated as round holes) -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
KEYHOLE_SLOT_PLATE = register_subsystem(Subsystem(
    name="keyhole_slot_plate",
    description="Plate with keyhole-shape hanging slots -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    ...
    params=[
        ...
        ParamSpec("hole_dia_mm", value=6.0, min=2.0, max=15.0, unit='mm'),
