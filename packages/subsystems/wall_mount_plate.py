"""Wall Mount Plate -- Plate with mounting slots + peg attachment point
...
_FRAGMENT = """\
## Subsystem: Wall Mount Plate
Plate with mounting slots + peg attachment point -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
WALL_MOUNT_PLATE = register_subsystem(Subsystem(
    name="wall_mount_plate",
    description="Plate with mounting slots + peg attachment point -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=50.0, min=15.0, max=180.0, unit='mm'),
