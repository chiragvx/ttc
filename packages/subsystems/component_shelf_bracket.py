"""Component Shelf Bracket -- Small shelf bracket for a boxed component

Structural/mounting geometry only (`build-plan/reference/UAV_SUBSYSTEM_PROPOSALS.md` category
6) -- two perpendicular flanges sharing a corner, the SAME shape family `lbracket.py`
...
_FRAGMENT = """\
## Subsystem: Component Shelf Bracket
Small shelf bracket for a boxed component -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
COMPONENT_SHELF_BRACKET = register_subsystem(Subsystem(
    name="component_shelf_bracket",
    description="Small shelf bracket for a boxed component -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
