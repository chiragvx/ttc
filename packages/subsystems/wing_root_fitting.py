"""Wing Root Fitting -- Attachment fitting where the wing meets the fuselage
...
_FRAGMENT = """\
## Subsystem: Wing Root Fitting
Attachment fitting where the wing meets the fuselage -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
WING_ROOT_FITTING = register_subsystem(Subsystem(
    name="wing_root_fitting",
    description="Attachment fitting where the wing meets the fuselage -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=50.0, min=20.0, max=150.0, unit='mm'),
        ParamSpec("leg_b_mm", value=50.0, min=20.0, max=150.0, unit='mm'),
