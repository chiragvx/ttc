"""Antenna Mount Plate -- Plate + boss for a patch or whip antenna base
...
_FRAGMENT = """\
## Subsystem: Antenna Mount Plate
Plate + boss for a patch or whip antenna base -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
ANTENNA_MOUNT_PLATE = register_subsystem(Subsystem(
    name="antenna_mount_plate",
    description="Plate + boss for a patch or whip antenna base -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=30.0, min=10.0, max=100.0, unit='mm'),
        ParamSpec("depth_mm", value=30.0, min=10.0, max=100.0, unit='mm'),
