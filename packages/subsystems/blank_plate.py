"""Blank Plate -- Featureless rectangular plate
...
_FRAGMENT = """\
## Subsystem: Blank Plate
Featureless rectangular plate -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
BLANK_PLATE = register_subsystem(Subsystem(
    name="blank_plate",
    description="Featureless rectangular plate -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=60.0, min=15.0, max=250.0, unit='mm'),
        ParamSpec("depth_mm", value=40.0, min=10.0, max=200.0, unit='mm'),
        ParamSpec("thickness_mm", value=3.0, min=0.8, max=15.0, unit='mm'),
        ParamSpec("hole_dia_mm", value=3.0, min=1.0, max=8.0, unit='mm'),
        ParamSpec("n_holes", value=0, min=0, max=0, unit='count'),
