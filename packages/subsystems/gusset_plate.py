"""Gusset Plate -- Right-triangle plate (a corner brace) (triangular brace approximated as an L-bracket)
...
_FRAGMENT = """\
## Subsystem: Gusset Plate
Right-triangle plate (a corner brace) (triangular brace approximated as an L-bracket) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
GUSSET_PLATE = register_subsystem(Subsystem(
    name="gusset_plate",
    description="Right-triangle plate (a corner brace) -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=35.0, min=12.0, max=100.0, unit='mm'),
        ParamSpec("leg_b_mm", value=35.0, min=12.0, max=100.0, unit='mm'),
