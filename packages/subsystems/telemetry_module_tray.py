"""Telemetry Module Tray -- Tray sized to a telemetry radio module
...
_FRAGMENT = """\
## Subsystem: Telemetry Module Tray
Tray sized to a telemetry radio module -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
TELEMETRY_MODULE_TRAY = register_subsystem(Subsystem(
    name="telemetry_module_tray",
    description="Tray sized to a telemetry radio module -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=40.0, min=12.0, max=150.0, unit='mm'),
        ParamSpec("depth_mm", value=30.0, min=10.0, max=120.0, unit='mm'),
