"""Strain Relief -- Two-jaw strain-relief clamp (represents one jaw half)
...
_FRAGMENT = """\
## Subsystem: Strain Relief
Two-jaw strain-relief clamp (represents one jaw half) -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
STRAIN_RELIEF = register_subsystem(Subsystem(
    name="strain_relief",
    description="Two-jaw strain-relief clamp -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=15.0, min=6.0, max=50.0, unit='mm'),
        ParamSpec("leg_b_mm", value=15.0, min=6.0, max=50.0, unit='mm'),
        ParamSpec("width_mm", value=12.0, min=4.0, max=40.0, unit='mm'),
