"""Linkage Clevis -- Clevis end-fitting for a pushrod
...
_FRAGMENT = """\
## Subsystem: Linkage Clevis
Clevis end-fitting for a pushrod -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
LINKAGE_CLEVIS = register_subsystem(Subsystem(
    name="linkage_clevis",
    description="Clevis end-fitting for a pushrod -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
