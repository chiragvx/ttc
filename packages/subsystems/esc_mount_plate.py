"""Esc Mount Plate -- Plate/standoffs for an ESC with airflow clearance
...
_FRAGMENT = """\
## Subsystem: Esc Mount Plate
Plate/standoffs for an ESC with airflow clearance -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
ESC_MOUNT_PLATE = register_subsystem(Subsystem(
    name="esc_mount_plate",
    description="Plate/standoffs for an ESC with airflow clearance -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
