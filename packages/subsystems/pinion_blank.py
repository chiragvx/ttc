"""Pinion Blank -- Small gear blank (short axial length, hub optional) (no teeth)
...
Small gear blank (short axial length, hub optional) (no teeth) -- a solid cylindrical body (FDM/FFF or turned). Fine surface detail (knurling, a domed
...
PINION_BLANK = register_subsystem(Subsystem(
    ...
    params=[
        ParamSpec("dia_mm", value=15.0, min=5.0, max=50.0, unit='mm'),
