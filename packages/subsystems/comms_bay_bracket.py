"""Comms Bay Bracket -- Bracket mounting a comms/radio module

Structural/mounting geometry only (`build-plan/reference/UAV_SUBSYSTEM_PROPOSALS.md` category
9) -- two perpendicular flanges sharing a corner, the SAME shape family `lbracket.py`
...
_FRAGMENT = """\
## Subsystem: Comms Bay Bracket
Bracket mounting a comms/radio module -- an angle bracket, two perpendicular flanges meeting at a corner (FDM/FFF or machined).
...
COMMS_BAY_BRACKET = register_subsystem(Subsystem(
    name="comms_bay_bracket",
    description="Bracket mounting a comms/radio module -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("leg_a_mm", value=22.0, min=10.0, max=70.0, unit='mm'),
        ParamSpec("leg_b_mm", value=22.0, min=10.0, max=70.0, unit='mm'),
        ParamSpec("width_mm", value=16.0, min=6.0, max=60.0, unit='mm'),
