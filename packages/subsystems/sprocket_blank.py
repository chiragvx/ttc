"""Sprocket Blank -- Sprocket disc with hub, no teeth (no teeth, matches the doc's own note)
...
Sprocket disc with hub, no teeth (no teeth, matches the doc's own note) -- a solid cylindrical body (FDM/FFF or turned). Fine surface detail (knurling, a domed
...
SPROCKET_BLANK = register_subsystem(Subsystem(
    ...
    params=[
        ParamSpec("dia_mm", value=40.0, min=12.0, max=130.0, unit='mm'),
