"""Ballast Tray -- Tray holding removable ballast weight

Structural/mounting geometry only (`build-plan/reference/UAV_SUBSYSTEM_PROPOSALS.md` category
14) -- a flat mounting plate with a row of bolt holes, the SAME shape family
...
_FRAGMENT = """\
## Subsystem: Ballast Tray
Tray holding removable ballast weight -- a flat plate with a row of bolt holes (FDM/FFF or CNC).
...
BALLAST_TRAY = register_subsystem(Subsystem(
    name="ballast_tray",
    description="Tray holding removable ballast weight -- structural/mounting geometry (FDM/FFF or CNC)",
    fragment=_FRAGMENT,
    disciplines=("structures", "manufacturing", "thermal"),
    params=[
        ParamSpec("width_mm", value=45.0, min=12.0, max=160.0, unit='mm'),
